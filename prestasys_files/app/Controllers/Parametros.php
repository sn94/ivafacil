...
class Parametros extends Controller
{
	...
	public function leer_mensajes()
	{
		$param = (new Parametros_model())->first();
		$retor = [
			'MSJ_PANTALLA_REGISTRO' =>   $param->MSJ_PANT_REGISTRO,
			'MSJ_PANTALLA_CIERRE_MES' =>  $param->MSJ_PANT_CIERRE_M,
			'MSJ_PANTALLA_RESUMEN_ANIO' =>  $param->MSJ_PANT_CIERRE_A,
		];
		return $this->response->setJSON($retor);
	}
}
