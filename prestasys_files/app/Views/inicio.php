...
<head>
  ...
  <style>
    ...
    html {
      ...
      background-image: linear-gradient(-170deg, #add7a7 20%, #298037) !important;
    }
    ...
    body {
      ...
      background-image: linear-gradient(270deg, #72df53 3px, transparent 0), linear-gradient(#69cc61 3px, transparent 0), linear-gradient(270deg, rgba(119, 204, 88, 0.4) 1px, transparent 0), linear-gradient(#72d75d 1px, transparent 0), linear-gradient(270deg, rgba(127, 208, 110, 0.4) 1px, transparent 0), linear-gradient(#76d06f 1px, transparent 0) !important;
    }
    ...
    div.justify-content-center.links{
      width: 40%;
    }
...
<body class="bg-success">
  ...
  <div class="container row">
    ...
    <div class="col-12 offset-md-4  col-md-4    links">
