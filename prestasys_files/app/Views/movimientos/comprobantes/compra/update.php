...
<div class="row mt-3">
    ...
    <div class="col-12  offset-md-3 col-md-6 ">
        <div class="container p-0">
            ...
            <form onsubmit="guardar_factura( event )" action="<?= base_url("compra/update")?>" method="post" class="pt-2 bg-light" style="border: 1px solid #cecece;border-radius: 0px 0px 15px 15px ;">

            
                 <?php 
                 echo view("movimientos/comprobantes/compra/form") ?>
