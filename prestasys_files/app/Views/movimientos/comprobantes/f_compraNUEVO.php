 ...
 <?= $this->section("section_menu") ?>
 <?= view("layouts/section_menu") ?>
 <?= $this->endSection() ?>
                             ...
                             <div class="row mt-3">
                                 ...
                                 <div class="col-12  offset-md-3 col-md-6 ">
                                     <div class="container p-0">
                                         <div  style="border-radius: 15px 15px 0px 0px; background-color: #e4e4e4; border-bottom: 1px solid #cecece;border-right: 1px solid #cecece; border-left: 1px solid #cecece;">
                                             <h4 style="color: #272727;" class="text-center">Registro de factura de compra</h4>
                                         </div>

                                         <form onsubmit="guardar_factura( event )" action="<?= base_url("compra/create") ?>" method="post"  style=" background-color: #e4e4e4; border: 1px solid #cecece;border-radius: 0px 0px 15px 15px ;">
