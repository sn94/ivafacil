        ...
        <nav class="navbar navbar-expand-sm navbar-default" >
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#"    aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Cierre del mes</a>
                        
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#>"    aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-tasks"></i>Resumen del año</a>
            ...
            <div class="header-menu">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <i class="fa fa-user"></i>   <?= session("ruc")."-".session("dv")?>
                        </a>

                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="<?=base_url("usuario/update/".session("id"))?>"><i class="fa fa-user"></i> Mis datos</a>

                            <a class="nav-link" href="#"><i class="fa fa-user"></i> Notificaciones <span class="count">13</span></a>

                            <a class="nav-link" href="#"><i class="fa fa-cog"></i> Settings</a>

                            <a class="nav-link" href="<?= base_url("usuario/sign-out")?>"><i class="fa fa-power-off"></i> Cerrar sesión</a>
                        </div>
                    </div>
